...
export default async function QuizResultPage({ params }: { params: { id: string, attemptId: string } }) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100 text-center mb-8 relative overflow-hidden">
          ...
          <div className="flex gap-4 justify-center">
             <Link href={`/luyen-tap/bai-tap/${attempt.quizId}`} className="px-6 py-2.5 bg-brand-teal text-white font-bold rounded-xl hover:bg-opacity-90">
               Làm lại
             </Link>
